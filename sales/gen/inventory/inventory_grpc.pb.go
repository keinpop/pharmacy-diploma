...
func (UnimplementedInventoryServiceServer) ReceiveBatch(context.Context, *ReceiveBatchRequest) (*BatchResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReceiveBatch not implemented")
}
...
func (UnimplementedInventoryServiceServer) ListExpiringBatches(context.Context, *ListExpiringRequest) (*ListExpiringResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListExpiringBatches not implemented")
}
func (UnimplementedInventoryServiceServer) ListLowStock(context.Context, *ListLowStockRequest) (*ListLowStockResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListLowStock not implemented")
}
func (UnimplementedInventoryServiceServer) WriteOffExpired(context.Context, *WriteOffExpiredRequest) (*WriteOffExpiredResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WriteOffExpired not implemented")
}
